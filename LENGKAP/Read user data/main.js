...
var flightPlanCoordinatespusher = {lat: -7.955326, lng: 112.610953};
...
function initMap() {
    ...
    function onMessageArrived(message) {
        ...
        //writeUserData(LocationResult.lat, LocationResult.lng, LocationResult)
    ...
    function gotData(data){
        ...
        for (var i = 0; i < keys.length; i++){
            var k = keys[i];
            var initials = parseFloat(scores[k].latitude);
            var scoree = parseFloat(scores[k].longitude);
            flightPlanCoordinatespusher.lng = parseFloat(initials);
            flightPlanCoordinatespusher.lat = parseFloat(scoree);
            flightPlanCoordinates.push(flightPlanCoordinatespusher);
            //console.log(flightPlanCoordinatespusher.lat);
        }
        console.log(flightPlanCoordinates);

        //document.getElementById("p2").innerHTML = flightPlanCoordinatespusher[0];
        //flightPlanCoordinates.push(flightPlanCoordinatespusher);
